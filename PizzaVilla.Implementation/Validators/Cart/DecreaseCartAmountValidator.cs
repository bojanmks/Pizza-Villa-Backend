...
{
    public class DecreaseCartAmountValidator : AbstractValidator<int>
    {
        public DecreaseCartAmountValidator(PVDbContext context, IApplicationActor user)
        {
            RuleFor(x => x)
                ...
                .Must(x => context.Cart.Find(x).Amount > 1)
                .WithMessage("Amount can't be lower than 1.");
        }
    }
}
