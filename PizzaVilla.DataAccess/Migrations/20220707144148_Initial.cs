    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartAddons", x => new { x.CartId, x.AddonId });
                    table.ForeignKey(
                        name: "FK_CartAddons_Addons_AddonId",
                        column: x => x.AddonId,
                        principalTable: "Addons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CartAddons_Cart_CartId",
                        column: x => x.CartId,
                        principalTable: "Cart",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartIngredients", x => new { x.CartId, x.IngredientId });
                    table.ForeignKey(
                        name: "FK_CartIngredients_Cart_CartId",
                        column: x => x.CartId,
                        principalTable: "Cart",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLog_ExecutionDateTime",
                table: "AuditLog",
                column: "ExecutionDateTime");

            migrationBuilder.CreateIndex(
                name: "IX_AuditLog_Identity",
                table: "AuditLog",
                column: "Identity");

            migrationBuilder.CreateIndex(
                name: "IX_AuditLog_UseCaseName",
                table: "AuditLog",
                column: "UseCaseName");
